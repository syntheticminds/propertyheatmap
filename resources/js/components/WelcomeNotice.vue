<template>
    <div v-show="!is_hidden" class="z-900 bg-white rounded-lg p-4 absolute top-4 left-16 mr-4">
        <button @click="is_hidden = true" type="button" class="float-right p-2 -mr-2 -mt-2">
